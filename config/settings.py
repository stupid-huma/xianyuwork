...
# -------------------------------------------------------------------------
    ...
    image_processor_mode: Literal["local", "api"] = "local"                          #！！！改这里
    # 可选值：
    # - "qwen"
    # - "openai"
    # - "gemini_flash"
...
# -------------------------------------------------------------------------
    ...
    image_prompt_mode: Literal["repair", "reference_generate", "custom"] = "repair"  #！！！改这里
    ...
    reference_generation_prompt: str = (
        "参考输入图的角色、画风、服饰、色彩和核心视觉元素，生成一张素描新图。"
